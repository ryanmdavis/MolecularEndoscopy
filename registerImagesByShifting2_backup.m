...
% now shift the image
im2_out=circshift(im2_rotated,round([reg_parameters.shift_rc 0])); % the zero is because we don't need to shift in the RGB channel dimension
im1_out=im1_padded;
