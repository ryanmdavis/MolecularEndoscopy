...
% include padding
reg_parameters.backwards_rot=@(row,col) ceil((round(rotz(-reg_parameters.rotation)*([col+reg_parameters.pad_size_rc(2)-reg_parameters.shift_rc(2)-reg_parameters.padded_im_center_xy(1) reg_parameters.padded_im_center_xy(2)-(row+reg_parameters.pad_size_rc(1)-reg_parameters.shift_rc(1)) 0].').*[1 -1 1].'+[reg_parameters.padded_im_center_xy(1)-reg_parameters.im2_pad_size_rc(2) reg_parameters.padded_im_center_xy(2)-reg_parameters.im2_pad_size_rc(1) 0].'))/reg_parameters.scale);